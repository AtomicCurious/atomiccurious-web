...
function SocialIcon({ name }: { name: Social["label"] }) {
...
export default function SocialLinks({
  ...
  const hoverColorByLabel: Record<Social["label"], string> = {
    ...
    TikTok:
      "group-hover:text-cyan-400 group-hover:border-cyan-400/30",
    Instagram:
      "group-hover:text-pink-400 group-hover:border-pink-400/30",
  }
