  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 20%, rgba(var(--accent)/0.16), transparent 70%)",
        }}
      />
...
export default function Page() {
  ...
  return (
    <main className="relative w-full overflow-hidden bg-bg text-text">
      {/* Signature cinematic backdrop (NOT home) */}
      <SignatureBackdrop />
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            ...
            <div className="relative order-2 lg:order-1">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at center, rgba(var(--accent)/0.14), transparent 66%)",
                }}
              />
              ...
              <div className="group relative">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle at 50% 50%, rgba(var(--accent)/0.12), transparent 62%)",
                    }}
                  />
                </div>
