...
/* ── PARTÍCULAS DE CELEBRACIÓN: estrellas doradas ── */
.ac-sparks{
  position: absolute;
  inset: 0;
  pointer-events: none;
...
/* Estrella grande izq */
.ac-spark-1{
  left: 6%; top: 12%; font-size: 18px; color: rgba(255,240,180,0.92);
  text-shadow: 0 0 10px rgba(198,171,103,0.60);
  animation: acSparkFloat 8s ease-in-out infinite;
  animation-delay: 0.2s;
}
/* Estrella peq centro-izq */
.ac-spark-2{
  left: 22%; top: 8%; font-size: 11px; color: rgba(255,248,210,0.80);
  text-shadow: 0 0 8px rgba(198,171,103,0.45);
  animation: acSparkFloat 7s ease-in-out infinite;
  animation-delay: 1.1s;
}
/* Estrella med centro */
.ac-spark-3{
  left: 44%; top: 6%; font-size: 15px; color: rgba(255,235,160,0.85);
  text-shadow: 0 0 12px rgba(198,171,103,0.55);
  animation: acSparkFloat 9s ease-in-out infinite;
  animation-delay: 2.4s;
}
/* Estrella grande der */
.ac-spark-4{
  left: 74%; top: 10%; font-size: 20px; color: rgba(255,242,190,0.90);
  text-shadow: 0 0 12px rgba(198,171,103,0.60);
  animation: acSparkFloat 8.5s ease-in-out infinite;
  animation-delay: 0.6s;
}
/* Estrella peq der */
.ac-spark-5{
  left: 90%; top: 7%; font-size: 10px; color: rgba(255,248,210,0.75);
  text-shadow: 0 0 7px rgba(198,171,103,0.40);
  animation: acSparkFloat 7.5s ease-in-out infinite;
  animation-delay: 3.2s;
}
/* Segunda fila — más tenues */
.ac-spark-6{
  left: 14%; top: 28%; font-size: 9px; color: rgba(255,240,185,0.55);
  text-shadow: 0 0 6px rgba(198,171,103,0.30);
  animation: acSparkFloat 11s ease-in-out infinite;
  animation-delay: 1.8s;
}
.ac-spark-7{
  left: 58%; top: 22%; font-size: 13px; color: rgba(255,245,200,0.60);
  text-shadow: 0 0 8px rgba(198,171,103,0.34);
  animation: acSparkFloat 10s ease-in-out infinite;
  animation-delay: 4.0s;
}
.ac-spark-8{
  left: 82%; top: 26%; font-size: 8px; color: rgba(255,248,215,0.50);
  text-shadow: 0 0 5px rgba(198,171,103,0.28);
  animation: acSparkFloat 12s ease-in-out infinite;
  animation-delay: 2.8s;
}
/* Rombos pequeños */
.ac-spark-9{
  left: 35%; top: 16%; font-size: 8px; color: rgba(255,235,165,0.50);
  animation: acSparkFloat 13s ease-in-out infinite;
  animation-delay: 5.1s;
}
.ac-spark-10{
  left: 66%; top: 8%; font-size: 7px; color: rgba(255,248,210,0.45);
  animation: acSparkFloat 10.5s ease-in-out infinite;
...
@keyframes acSparkFloat{
  0%{
    opacity: 0;
    transform: translateY(8px) scale(0.80) rotate(-8deg);
  }
  10%{
    opacity: 1;
...
/* Máscara: las chispas se evaporan hacia abajo */
.ac-sparks{
...
/* ── CHECK BURST: ícono de celebración ── */
.ac-burst-wrap{
  position: relative;
  display: inline-flex;
  align-items: center;
...
/* Onda exterior que se expande y desvanece */
.ac-burst-ring{
  position: absolute;
  inset: -12px;
  border-radius: 9999px;
            ...
            <div className="ac-editorial-shell relative overflow-hidden rounded-[28px] border border-border/70 bg-surface-1/45 p-6 shadow-soft backdrop-blur-xl sm:p-10 md:p-12">
              ...
              <div className="relative text-center">
                ...
                <p className="ac-reveal ac-delay-4 mx-auto mt-5 max-w-2xl text-balance text-base leading-7 text-muted sm:text-lg">
                  Tu suscripción quedó confirmada. A partir de ahora formas parte de AtomicCurious:
                <br />
                  ideas y exploraciones seleccionadas, con acceso anticipado a nuevos contenidos, recursos y novedades. 
                </p>
                ...
                <div className="ac-pill ac-reveal ac-delay-6 mx-auto mt-7 inline-flex items-center gap-2 rounded-full border border-border/70 bg-bg/25 px-4 py-2 text-xs font-semibold text-text shadow-soft backdrop-blur">
                  ...
                  <span className="relative z-[1]">Suscripción activa</span>
                </div>
                ...
                <div className="ac-reveal ac-delay-7 mx-auto mt-8 grid max-w-3xl gap-3 text-left sm:grid-cols-3">
                  <div className="ac-step-card rounded-2xl border border-transparent bg-bg/20 p-4">
                    ...
                    <p className="mt-2 text-sm font-medium text-text">
                      Nuevas entregas directamente en tu correo, dos veces al mes.
                    </p>
                  </div>
                  ...
                  <div className="ac-step-card rounded-2xl border border-transparent bg-bg/20 p-4">
                    ...
                    <p className="mt-2 text-sm font-medium text-text">
                      Herramientas y recomendaciones seleccionadas para pensar mejor.
                    </p>
                  </div>
                  ...
                  <div className="ac-step-card rounded-2xl border border-transparent bg-bg/20 p-4">
                    ...
                    <p className="mt-2 text-sm font-medium text-text">
                      Cada entrega está diseñada para expandir tu curiosidad.
                    </p>
                  </div>
                </div>
