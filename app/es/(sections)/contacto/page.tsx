...
export const metadata = {
  ...
  description:
    "Ideas, colaboraciones, feedback o simplemente algo interesante que contarnos.",
  alternates: {
...
const TOPIC_TAGS = ["Colaboraciones", "Ideas", "Feedback", "Proyectos"]
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 py-14 sm:px-10 sm:py-20">
          <header className="ac-contact-header mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-4 text-balance text-4xl font-semibold tracking-tight text-text sm:text-5xl">
              Escríbenos. <span className="ac-contact-kicker">Leemos todo.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              >
                Únete al <span className="ml-1 ac-contact-kicker">boletín</span>
              </Link>
                ...
                <div className="ac-contact-visual relative flex h-full w-full overflow-hidden rounded-3xl border border-border/70 bg-surface-1 shadow-soft">
                  ...
                  <div className="relative flex h-full w-full flex-col">
                    <div className="relative h-[520px] w-full shrink-0">
                      <Image
                        src="/images/sections/contact/atom_contacto.webp"
                        alt=""
                        aria-hidden="true"
                        fill
                      ...
                      <Image
                        src="/images/sections/contact/iris_contacto.webp"
                        alt=""
                        aria-hidden="true"
                        fill
                        sizes="(min-width: 768px) 420px, 90vw"
                      ...
                      <Image
                        src="/images/sections/contact/core_contacto.webp"
                        alt=""
                        aria-hidden="true"
                        fill
                        sizes="(min-width: 768px) 420px, 90vw"
                    ...
                    <div className="relative flex flex-1 flex-col px-5 py-4">
                      ...
                      <p className="ac-contact-note mt-1 text-sm leading-relaxed text-muted">
                        ...
                        comparte <strong>enlaces</strong> y suficiente contexto para entender rápido la idea.
                      </p>

                      <div className="ac-contact-aside-divider mt-4" />

                      <div className="mt-auto">
                        <p className="ac-contact-tags-label">Temas frecuentes</p>
