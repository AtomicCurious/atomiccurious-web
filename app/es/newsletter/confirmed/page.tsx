...
export default function Page() {
  ...
  const title =
    state === "success"
      ...
      : state === "missing"
      ? "Falta el token de confirmación"
  ...
  const description =
    state === "success"
      ...
      : state === "invalid"
      ? "Este enlace de confirmación es inválido o ya fue utilizado."
      : state === "expired"
      ? "Este enlace de confirmación ha expirado. Vuelve a suscribirte."
      : state === "missing"
      ? "Este enlace de confirmación está incompleto."
      : state === "error"
      ? "Ocurrió un error al confirmar tu suscripción."
      : "Haz clic en el botón de abajo para completar tu suscripción al boletín de AtomicCurious."
              ...
              <div className="relative overflow-hidden rounded-2xl border border-border/70 bg-bg/20 shadow-soft">
                <div className="relative aspect-video w-full">
                  ...
                  <Image
                    ...
                    alt="Core listo para confirmar tu suscripción"
                    fill
